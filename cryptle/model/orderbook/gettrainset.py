...
def event_count(diffs):
    return {
        'create_ask': len(
            diffs[(diffs['diff_type'] == 'create') & (diffs['order_type'] == 'ask')]
        ),
        'take_ask': len(
            diffs[(diffs['diff_type'] == 'change') & (diffs['order_type'] == 'ask')]
        ),
        'delete_ask': len(
            diffs[(diffs['diff_type'] == 'delete') & (diffs['order_type'] == 'ask')]
        ),
        'create_bid': len(
            diffs[(diffs['diff_type'] == 'create') & (diffs['order_type'] == 'bid')]
        ),
        'take_bid': len(
            diffs[(diffs['diff_type'] == 'change') & (diffs['order_type'] == 'bid')]
        ),
        'delete_bid': len(
            diffs[(diffs['diff_type'] == 'delete') & (diffs['order_type'] == 'bid')]
        ),
    }
...
def event_count_1(diffs):
    return (
        len(diffs[(diffs['diff_type'] == 'create') & (diffs['order_type'] == 'ask')]),
        len(diffs[(diffs['diff_type'] == 'create') & (diffs['order_type'] == 'bid')]),
        len(diffs[(diffs['diff_type'] == 'change') & (diffs['order_type'] == 'ask')]),
        len(diffs[(diffs['diff_type'] == 'change') & (diffs['order_type'] == 'bid')]),
        len(diffs[(diffs['diff_type'] == 'delete') & (diffs['order_type'] == 'ask')]),
        len(diffs[(diffs['diff_type'] == 'delete') & (diffs['order_type'] == 'bid')]),
    )
...
def get_snap_shot(j, labeling):
    ...
    diffs_0 = diffs[
        (diffs.datetime >= start_time) & (diffs.datetime < start_time + period)
    ]
    ...
    diffs_2 = diffs[
        (diffs.datetime >= start_time - 2 * period)
        & (diffs.datetime < start_time + period)
    ]
