...
mostly concerned with transforming series with rolling windows. Users are reminded to take care of the varying length of series returned due to nature of metrics generated by rolling windows.
'''
