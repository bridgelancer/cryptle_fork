...
indices and metrics related to time series.

Currently avaiable functions can be classificed to two types. The first type are
vanilla/naive transformations that use particular types of weighting to
calculate moving averages. The second type builds on the last, using
combinations of moving averages to create new metrics.
...
Note:
    MACD returns 2 lists.

Todo:
    * Rename bollinger functions to generic names of what the functions are
